...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_LATENCY, 30);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_SENSOR_ROTATE_COMMON, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_SENSOR_ROTATE_VAR, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_KEYMAP_SENSORS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_KEYMAP_SENSORS_DEFAULT_TRIGGERS_PER_ROTATION, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_KYRIA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_KYRIA_LEFT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ALPS_EC11_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_SENSOR_ROTATE_VAR_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_KEYMAP_SENSORS_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_PHYSICAL_LAYOUT_POSITION_MAP_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EC11, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EC11_TRIGGER_NONE, 1);
